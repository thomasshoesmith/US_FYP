...
void allocateMem() {
    ...
    pushMergedNeuronUpdateGroup1ToDevice(0, glbSpkCntconv2d_1_nrn, glbSpkconv2d_1_nrn, Fxconv2d_1_nrn, Vmemconv2d_1_nrn, inSynconv2d_to_conv2d_1_syn, 512, 8.93170381433823479e+00f, 1.89540931851256134e+00f, 3.48894680247587297e-02f, 7.40394265043969272e-03f);
    pushMergedNeuronUpdateGroup1ToDevice(1, glbSpkCntconv2d_nrn, glbSpkconv2d_nrn, Fxconv2d_nrn, Vmemconv2d_nrn, inSynconv2d_input_to_conv2d_syn, 9216, 1.89540931851256134e+00f, 1.00392156862745097e+00f, 7.40394265043969272e-03f, 3.92156862745098034e-03f);
    pushMergedNeuronUpdateGroup1ToDevice(2, glbSpkCntdense_1_nrn, glbSpkdense_1_nrn, Fxdense_1_nrn, Vmemdense_1_nrn, inSyndense_to_dense_1_syn, 64, 1.07393449371936267e+01f, 8.46271924785539298e+00f, 4.19505661609126043e-02f, 3.30574970619351288e-02f);
    pushMergedNeuronUpdateGroup1ToDevice(3, glbSpkCntdense_2_nrn, glbSpkdense_2_nrn, Fxdense_2_nrn, Vmemdense_2_nrn, inSyndense_1_to_dense_2_syn, 10, 1.00392144895067403e+00f, 1.07393449371936267e+01f, 3.92156815996357044e-03f, 4.19505661609126043e-02f);
    pushMergedNeuronUpdateGroup1ToDevice(4, glbSpkCntdense_nrn, glbSpkdense_nrn, Fxdense_nrn, Vmemdense_nrn, inSynconv2d_1_to_dense_syn, 128, 8.46271924785539298e+00f, 8.93170381433823479e+00f, 3.30574970619351288e-02f, 3.48894680247587297e-02f);
