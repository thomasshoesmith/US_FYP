...
void allocateMem() {
    ...
    pushMergedNeuronUpdateGroup1ToDevice(0, glbSpkCntconv2d_1_nrn, glbSpkconv2d_1_nrn, Fxconv2d_1_nrn, Vmemconv2d_1_nrn, inSynconv2d_to_conv2d_1_syn, 512, 7.56891371783088207e+00f, 2.31019239238664209e+00f, 2.95660692102768831e-02f, 9.02418903276032067e-03f);
    pushMergedNeuronUpdateGroup1ToDevice(1, glbSpkCntconv2d_nrn, glbSpkconv2d_nrn, Fxconv2d_nrn, Vmemconv2d_nrn, inSynconv2d_input_to_conv2d_syn, 9216, 2.31019239238664209e+00f, 1.00392156862745097e+00f, 9.02418903276032067e-03f, 3.92156862745098034e-03f);
    pushMergedNeuronUpdateGroup1ToDevice(2, glbSpkCntdense_1_nrn, glbSpkdense_1_nrn, Fxdense_1_nrn, Vmemdense_1_nrn, inSyndense_to_dense_1_syn, 64, 1.27945858226102942e+01f, 9.12875402113970580e+00f, 4.99788508695714617e-02f, 3.56591953950769758e-02f);
    pushMergedNeuronUpdateGroup1ToDevice(3, glbSpkCntdense_2_nrn, glbSpkdense_2_nrn, Fxdense_2_nrn, Vmemdense_2_nrn, inSyndense_1_to_dense_2_syn, 10, 1.00392156862745097e+00f, 1.27945858226102942e+01f, 3.92156862745098034e-03f, 4.99788508695714617e-02f);
    pushMergedNeuronUpdateGroup1ToDevice(4, glbSpkCntdense_nrn, glbSpkdense_nrn, Fxdense_nrn, Vmemdense_nrn, inSynconv2d_1_to_dense_syn, 128, 9.12875402113970580e+00f, 7.56891371783088207e+00f, 3.56591953950769758e-02f, 2.95660692102768831e-02f);
