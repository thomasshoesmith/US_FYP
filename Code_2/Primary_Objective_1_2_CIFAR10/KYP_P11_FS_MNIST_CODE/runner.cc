...
void allocateMem() {
    ...
    pushMergedNeuronUpdateGroup1ToDevice(0, glbSpkCntconv2d_1_nrn, glbSpkconv2d_1_nrn, Fxconv2d_1_nrn, Vmemconv2d_1_nrn, inSynconv2d_to_conv2d_1_syn, 512, 7.50060077742034270e+00f, 2.19246132046568620e+00f, 2.92992217867982137e-02f, 8.56430203306908673e-03f);
    pushMergedNeuronUpdateGroup1ToDevice(1, glbSpkCntconv2d_nrn, glbSpkconv2d_nrn, Fxconv2d_nrn, Vmemconv2d_nrn, inSynconv2d_input_to_conv2d_syn, 9216, 2.19246132046568620e+00f, 1.00392156862745097e+00f, 8.56430203306908673e-03f, 3.92156862745098034e-03f);
    pushMergedNeuronUpdateGroup1ToDevice(2, glbSpkCntdense_1_nrn, glbSpkdense_1_nrn, Fxdense_1_nrn, Vmemdense_1_nrn, inSyndense_to_dense_1_syn, 64, 1.37736749387254900e+01f, 6.67184292662377487e+00f, 5.38034177293964452e-02f, 2.60618864321241206e-02f);
    pushMergedNeuronUpdateGroup1ToDevice(3, glbSpkCntdense_2_nrn, glbSpkdense_2_nrn, Fxdense_2_nrn, Vmemdense_2_nrn, inSyndense_1_to_dense_2_syn, 10, 1.00392108992034323e+00f, 1.37736749387254900e+01f, 3.92156675750134076e-03f, 5.38034177293964452e-02f);
    pushMergedNeuronUpdateGroup1ToDevice(4, glbSpkCntdense_nrn, glbSpkdense_nrn, Fxdense_nrn, Vmemdense_nrn, inSynconv2d_1_to_dense_syn, 128, 6.67184292662377487e+00f, 7.50060077742034270e+00f, 2.60618864321241206e-02f, 2.92992217867982137e-02f);
