                    ...
                    scalar lg;
                     {
                        ...
                        const int pool_ih = (3.20000000000000000e+01), pool_iw = (3.20000000000000000e+01), pool_ic = (3.20000000000000000e+01);
                        ...
                        if ((poolInRow < (poolStrideRow + pool_kh)) && (poolInCol < (poolStrideCol + pool_kw))) {
                            ...
                            const int dense_iw = (1.60000000000000000e+01), dense_ic = (3.20000000000000000e+01);
