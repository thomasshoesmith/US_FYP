...
void allocateMem() {
    ...
    pushMergedNeuronUpdateGroup1ToDevice(0, glbSpkCntconv2d_1_nrn, glbSpkconv2d_1_nrn, Fxconv2d_1_nrn, Vmemconv2d_1_nrn, inSynconv2d_to_conv2d_1_syn, 32768, 2.31452780330882346e+00f, 1.01535153856464455e+00f, 9.04112423167509165e-03f, 3.96621694751814278e-03f);
    pushMergedNeuronUpdateGroup1ToDevice(1, glbSpkCntconv2d_nrn, glbSpkconv2d_nrn, Fxconv2d_nrn, Vmemconv2d_nrn, inSynconv2d_input_to_conv2d_syn, 32768, 1.01535153856464455e+00f, 5.28702242650265219e-01f, 3.96621694751814278e-03f, 2.06524313535259851e-03f);
    pushMergedNeuronUpdateGroup1ToDevice(2, glbSpkCntdense_nrn, glbSpkdense_nrn, Fxdense_nrn, Vmemdense_nrn, inSynconv2d_1_to_dense_syn, 10, 9.95519480985753713e-01f, 2.31452780330882346e+00f, 3.88874797260060044e-03f, 9.04112423167509165e-03f);
