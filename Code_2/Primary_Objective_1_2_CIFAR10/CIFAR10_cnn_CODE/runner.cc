...
void allocateMem() {
    ...
    pushMergedNeuronUpdateGroup1ToDevice(0, glbSpkCntconv2d_1_nrn, glbSpkconv2d_1_nrn, Fxconv2d_1_nrn, Vmemconv2d_1_nrn, inSynconv2d_to_conv2d_1_syn, 32768, 4.38485466452205852e+00f, 1.76263894473805149e+00f, 1.71283385332892911e-02f, 6.88530837788301365e-03f);
    pushMergedNeuronUpdateGroup1ToDevice(1, glbSpkCntconv2d_nrn, glbSpkconv2d_nrn, Fxconv2d_nrn, Vmemconv2d_nrn, inSynconv2d_input_to_conv2d_syn, 32768, 1.76263894473805149e+00f, 5.28702242650265219e-01f, 6.88530837788301365e-03f, 2.06524313535259851e-03f);
    pushMergedNeuronUpdateGroup1ToDevice(2, glbSpkCntdense_nrn, glbSpkdense_nrn, Fxdense_nrn, Vmemdense_nrn, inSynconv2d_1_to_dense_syn, 10, 1.00390050551470589e+00f, 4.38485466452205852e+00f, 3.92148634966681987e-03f, 1.71283385332892911e-02f);
